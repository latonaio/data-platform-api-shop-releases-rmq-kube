...
import (
	...
	"data-platform-api-shop-releases-rmq-kube/config"
...
func (c *DPFMAPICaller) headerRelease(
	...
	header.IsReleaseled = input.Shop.IsReleaseled
	res, err := c.rmq.SessionKeepRequest(nil, c.conf.RMQ.QueueToSQL()[0], map[string]interface{}{"message": header, "function": "ShopHeader", "runtime_session_id": sessionID})
	if err != nil {
